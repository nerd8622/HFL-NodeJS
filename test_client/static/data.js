...
class MnistData {
  ...
  async load(beginInd, sampleSize) {
    ...
    this.trainImages =
        this.datasetImages.slice(IMAGE_SIZE * beginInd, IMAGE_SIZE * (beginInd+sampleSize));
    this.testImages = this.datasetImages.slice(IMAGE_SIZE * NUM_TRAIN_ELEMENTS);
    this.trainLabels =
        this.datasetLabels.slice(NUM_CLASSES * beginInd, NUM_CLASSES * (beginInd+sampleSize));
    this.testLabels =
   ...
   *
   * @returns
   *   xs: The data tensor, of shape `[numTrainExamples, 724]`.
   ...
   * @returns
   *   xs: The data tensor, of shape `[numTestExamples, 724]`.
   *   labels: The one-hot encoded labels tensor, of shape
   *     `[numTestExamples, 10]`.
   */
